  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader
        ...
        actions={
          <Link href={ROUTES.returnNew} className="btn-primary">
      ...
      {isLoading ? (
        ...
        <EmptyState
          ...
          description="Process a return to see it listed here."
        />
      ) : (
        <div className="flex flex-col gap-4">
          <div className="table-wrap">
            <table className="w-full min-w-[640px] text-sm">
              ...
              <tbody>
                {data.items.map((item) => (
                  <tr key={item.returnId} className="table-row">
                    <td className="px-4 py-3">
                      <StatusBadge
                        label={item.returnType}
                        tone={RETURN_TYPE_TONE[item.returnType]}
                      />
                    </td>
